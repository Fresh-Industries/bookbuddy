  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.body}>Set goals and keep your reading streak alive.</Text>
        <TouchableOpacity style={styles.button} onPress={() => router.push('/(auth)/(onboarding)/onBoardingUsername')}>
